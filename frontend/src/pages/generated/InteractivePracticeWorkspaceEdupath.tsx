...
<button className="px-4 py-2.5 rounded-xl bg-surface-container-lowest border border-tertiary text-tertiary hover:bg-tertiary hover:text-white font-label-md text-label-md font-semibold transition-all flex items-center gap-2" id="submitBtn">
<span className="material-symbols-outlined text-[18px]">verified</span>
          Submit Practice Milestone
        </button>
</div>
</div>
